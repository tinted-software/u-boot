...
else ifneq (,$(findstring $(MK_ARCH), "aarch64" "arm64" "armv8l"))
...
export ARCH SRCARCH CONFIG_SHELL BASH HOSTCC KBUILD_HOSTCFLAGS CROSS_COMPILE AS LD CC LLVM LLVM_IAS
...
CLANG_TARGET_FLAGS_sandbox	:= $(shell $(HOSTCC) -dumpmachine 2>/dev/null)
